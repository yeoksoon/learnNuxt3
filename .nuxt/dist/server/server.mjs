import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, ref, provide, computed, defineAsyncComponent, unref, h, Suspense, nextTick, mergeProps, Fragment, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "D:/study/learnNuxt-3/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "D:/study/learnNuxt-3/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "D:/study/learnNuxt-3/node_modules/h3/dist/index.mjs";
...
import { toRouteMatcher, createRouter } from "D:/study/learnNuxt-3/node_modules/radix3/dist/index.mjs";
import { defu, defuFn } from "D:/study/learnNuxt-3/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "D:/study/learnNuxt-3/node_modules/ufo/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "D:/study/learnNuxt-3/node_modules/@unhead/vue/dist/index.mjs";
import { klona } from "D:/study/learnNuxt-3/node_modules/klona/dist/index.mjs";
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-Maj_W8Lz.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Cb6m4BG5.js")
  },
  {
    name: __nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name,
    path: "/course",
    component: () => import("./_nuxt/course-CFRgIpGx.js"),
    children: [
      {
        name: "course",
        path: "",
        component: () => import("./_nuxt/index-BumiPa86.js")
      },
      {
        name: "course-courseSlug",
        path: ":courseSlug()",
        meta: __nuxt_page_meta$1 || {},
        component: () => import("./_nuxt/_courseSlug_-BRcWcs32.js")
      }
    ]
  },
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import("./_nuxt/_...slug_-D5kuKFdS.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-DSB75y-c.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CcXAJ69s.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Ce5oCsQH.js"));
