import { markRaw, defineComponent, inject, ref, h, Suspense, hasInjectionContext, provide, shallowReactive, Fragment, getCurrentInstance, createElementBlock, defineAsyncComponent, computed, unref, useSSRContext, createApp, withCtx, createVNode, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, nextTick, mergeProps, getCurrentScope } from 'vue';
import { k as hasProtocol, l as isScriptProtocol, m as joinURL, w as withQuery, n as sanitizeStatusCode, o as getContext, $ as $fetch, p as createHooks, q as executeAsync, r as defuFn, h as createError$1, v as toRouteMatcher, x as createRouter$1, y as defu, z as klona } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-Maj_W8Lz.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Cb6m4BG5.mjs')
  },
  {
    name: void 0 ,
    path: "/course",
    component: () => import('./course-CFRgIpGx.mjs'),
    children: [
      {
        name: "course",
        path: "",
        component: () => import('./index-BumiPa86.mjs')
      },
      {
        name: "course-courseSlug",
        path: ":courseSlug()",
        meta: __nuxt_page_meta$1 || {},
        component: () => import('./_courseSlug_-BRcWcs32.mjs')
      }
    ]
  },
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import('./_...slug_-D5kuKFdS.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DSB75y-c.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CcXAJ69s.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Ce5oCsQH.mjs'));
...
export { __nuxt_component_6 as _, client as a, stop as b, createComponent as c, pageContainerKey as d, emptyRenderFn as e, formKey as f, listenOpts as g, createDirective as h, isRuntimeSsrPreHydration as i, useHead as j, useRouter as k, layoutKey as l, useNuxtApp as m, noop as n, useRuntimeConfig as o, prevent as p, navigateTo as q, resolveRouteObject as r, stopAndPrevent as s, nuxtLinkDefaults as t, useRoute as u, server as v };
